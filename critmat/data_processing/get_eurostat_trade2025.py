...
def get_eurostat_trade2025(file,code_file,source,publish_year,load_temp=False,testing=False):
    ...
    return df, None #The second output is for the log, which is currently not implemented
