...
def get_bgs2025(file,source,publish_year,db_out=True):
    ...
    return resultdf, None #The second output is for the log, which is currently not implemented for BGS2025
